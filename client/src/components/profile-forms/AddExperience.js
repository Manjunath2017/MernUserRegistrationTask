      ...
      <section className="container">
        ...
        <form className="form" onSubmit={
          ...
          <div className="form-group">
            <input type="text" placeholder="* Job Title" name="title" onChange={(e) => onChange(e)} value={title} />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            <textarea name="description" cols="30" rows="5" placeholder="Job Description" onChange={(e) => onChange(e)} value={description}> </textarea>
          </div>
